export const reviews = {
  en: [
    {
      text: 'Fabiel.Net changed our lives! We launched our online store in just 2 weeks and are already selling like never before.',
      author: 'Maria G., Founder of Latina Store',
      verified: 'Verified Client ✓'
    },
    {
      text: 'The experience with Fabiel.Net was amazing. They guided us step by step and helped us avoid costly mistakes. They are the best!',
      author: 'John P., Tech Entrepreneur',
      verified: 'Verified Client ✓'
    },
    {
      text: 'I love how Fabiel.Net takes the time to understand your needs and goals. They are true partners in your business success.',
      author: 'Sophia R., Service Business Owner',
      verified: 'Verified Client ✓'
    },
    {
    ...
    {
      text: 'What I like most about Fabiel.Net is their ability to explain complex concepts in a simple and accessible way. They are true experts in their field.',
      author: 'Louis G., Tech Startup Entrepreneur',
      verified: 'Verified Client ✓'
    },
    {
      text: 'After working with several digital service providers, I can say Fabiel.Net is the best. Their dedication, professionalism and results are unmatched.',
      author: 'Elena T., Consulting Business Owner',
      verified: 'Verified Client ✓'
    }
  ],
  es: [
