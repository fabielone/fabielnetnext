  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <header className="mb-12">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-4">10 Essential Tips to Start Your LLC in California</h1>
              ...
              <ol className="space-y-2 pl-5">
                {tips.map(tip => (
                  <li key={tip.id} className="text-purple-700 hover:text-purple-900">
                    <Link href={`#tip-${tip.id}`} className="flex items-start">
